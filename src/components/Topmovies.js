...
function Topmovies(prop) {
  ...
  return (
    <>
      <div
        id="explore" className=" left-0  mt-32 md:-mx-14 lg:-mx-36  " >
        <AnimationOnScroll animateIn="animate__lightSpeedInRight" duration={0.9}  >
          <div
            className=" pb-10 w-auto flex justify-center font-monoton max-sm:text-xl md:text-3xl text-submain">
            Top Movies
          </div>
        </AnimationOnScroll>
        <div
          ...
          {topmovies.map((anime) => (
            <motion.div
              ...
              <SwiperSlide
                ...
                style={{ height: `${slideHeight()}em`, transitionDuration: "0.7s", transitionTimingFunction: "ease-in-out" }}
                ...
                <div className=' ease-in-out absolute top-auto left-0 bottom-0 right-0 hidden group-hover:grid mb-4 max-sm:gap-2 md:gap-5 ' >
                  ...
                  <div className=' hidden lg:grid gap-4 '>
                    {anime.genres.slice(0, 3).map((genre) => (
                      <p
                        className=" bg-black bg-opacity-40 backdrop-blur-lg rounded-full w-auto text-center p-2 px-5 mx-auto flex max-sm:text-xs transition-all duration-300 ease-in-out"
                      >
                        {genre}
                      </p>
                    ))
                  ...
                  <button
                    className=" hover:px-10 bg-black bg-opacity-40 backdrop-blur-lg rounded-full w-auto text-center p-2 px-5 mx-auto flex max-sm:text-xs transition-all duration-300 ease-in-out"
                  >
                    <img
                  ...
                  <button
                    className=" hover:px-4 bg-black bg-opacity-40 backdrop-blur-lg rounded-full w-auto text-center p-2 px-5 mx-auto flex justify-center items-center max-sm:text-xs transition-all duration-300 ease-in-out"
                  >
                    <img
        ...
        <p className=' bg-rare3 h-[1.3px] rounded-xl mt-16 max-sm:mx-10 md:mx-28 lg:mx-40 ' ><p></p></p>
      </div>
